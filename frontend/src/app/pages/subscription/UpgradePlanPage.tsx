    ...
    return (
      <div className="space-y-8">
        <div className="max-w-lg mx-auto text-center py-16">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 mb-3">Welcome to Pro!</h1>
          <p className="text-slate-500 text-lg mb-8">Your account has been upgraded. Enjoy unlimited AI-powered studying!</p>
          <button
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-slate-900">Upgrade to Pro</h1>
          <p className="text-slate-500">Unlock unlimited AI studying power</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl">
        ...
        <div className="bg-white rounded-[2rem] border border-slate-100 shadow-sm p-8">
          <h2 className="text-xl font-extrabold text-slate-900 mb-6">Payment Details</h2>
          ...
          <div className="space-y-5">
            ...
            <div className="border-t border-slate-100 pt-5">
              <div className="flex justify-between text-sm mb-2">
                <span className="text-slate-500">Pro Plan ({billing})</span>
              ...
              <div className="flex justify-between font-extrabold text-slate-900 text-lg border-t border-slate-100 pt-3">
                <span>Due Today</span>
