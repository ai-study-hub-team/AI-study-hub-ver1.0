      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 space-y-8">
            ...
            >
              <div className="flex flex-col sm:flex-row items-center gap-8 mb-12 pb-12 border-b border-slate-100 dark:border-slate-800">
                <div className="relative group">
                  ...
                  <button className="absolute -bottom-2 -right-2 p-2 bg-white dark:bg-slate-800 rounded-xl shadow-lg border border-slate-200 dark:border-slate-700 text-blue-600 hover:scale-110 transition-transform">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div>
                    ...
                    <input 
                      type="text" 
                      defaultValue="Alex"
                      className="w-full px-5 py-3.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                    />
                  </div>
                  <div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <select className="w-full px-5 py-3.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all">
                ...
                <div className="sm:col-span-2">
                  ...
                  <textarea 
                    ...
                    className="w-full px-5 py-3.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-2xl outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all resize-none"
                  ></textarea>
                </div>
              </div>
          ...
          {activeTab === 'Security' && (
            ...
            >
              <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm">
                <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-8">Change Password</h3>
              ...
              <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 shadow-sm">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="w-14 h-7 bg-slate-200 dark:bg-slate-700 rounded-full relative cursor-pointer">
                    <div className="absolute left-1 top-1 w-5 h-5 bg-white dark:bg-slate-300 rounded-full transition-all"></div>
                  </div>
                </div>
                <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-bold text-slate-900 dark:text-white text-sm">Active Sessions</p>
                    <p className="text-xs text-slate-500 dark:text-slate-400">Currently logged in from 2 devices</p>
                  </div>
          ...
          {activeTab === 'Notifications' && (
            ...
            >
              <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-8">Notification Preferences</h3>
              <div className="space-y-8">
                {[
                  ...
                  <div key={idx} className="flex items-center justify-between py-4 border-b border-slate-100 dark:border-slate-800 last:border-0">
                    <div>
                      <p className="font-bold text-slate-900 dark:text-white">{pref.title}</p>
                      <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">{pref.desc}</p>
                    </div>
                    <div className={`w-14 h-7 rounded-full relative cursor-pointer transition-colors ${pref.enabled ? 'bg-blue-600' : 'bg-slate-200 dark:bg-slate-700'}`}>
                      <div className={`absolute top-1 w-5 h-5 bg-white dark:bg-slate-300 rounded-full transition-all ${pref.enabled ? 'left-8' : 'left-1'}`}></div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'Subscription' && (
            ...
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-blue-50 dark:bg-blue-500/10 rounded-full blur-3xl -mr-32 -mt-32 opacity-50"></div>
              ...
              <div className="relative z-10">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-12 pb-12 border-b border-slate-100 dark:border-slate-800">
                  <div>
                    <h3 className="text-2xl font-extrabold text-slate-900 dark:text-white mb-2">Pro Plan</h3>
                    <p className="text-slate-500 dark:text-slate-400 font-medium">Billed annually • $120/year</p>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 mb-12">
                  <div>
                    <h4 className="font-bold text-slate-900 dark:text-white mb-6">Plan Benefits</h4>
                  ...
                  <div className="p-8 bg-slate-50 dark:bg-slate-800 rounded-[2rem] border border-slate-200 dark:border-slate-700">
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      <div className="w-12 h-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded flex items-center justify-center font-bold text-slate-900 dark:text-white text-xs">VISA</div>
                      <div>
                        <p className="text-sm font-bold text-slate-900 dark:text-white">•••• 4242</p>
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest">Expires 12/26</p>
                      </div>
                      <button className="ml-auto text-sm font-bold text-blue-600 hover:underline">Edit</button>
                    </div>
                    <button className="w-full py-4 text-sm font-bold text-red-500 border border-red-100 dark:border-red-500/30 rounded-xl hover:bg-red-50 dark:hover:bg-red-500/10 transition-colors">
                      Cancel Subscription
                    </button>
                  </div>
                </div>
